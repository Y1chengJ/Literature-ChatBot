...
# Remove or modify this parent package reference
# from .. import BaseSearch

# Change relative imports to absolute imports
from retriever.faiss_index import FaissBinaryIndex, FaissHNSWIndex, FaissIndex, FaissTrainIndex
from util import load_tsv_to_dict, save_dict_to_tsv

logger = logging.getLogger(__name__)


# Create a simple BaseSearch class since we can't import it from parent package
class BaseSearch:
